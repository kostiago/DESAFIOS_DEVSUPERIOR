...
public class ClientController {
    ...
    public ResponseEntity<ClientRecord> findById(@PathVariable Long id) {
        ClientRecord dto = service.findById(id);
        return ResponseEntity.ok(dto);
    }

    @GetMapping
    public ResponseEntity<Page<ClientRecord>> findAll(Pageable pageable) {
        Page<ClientRecord> dto = service.findAll(pageable);
        return ResponseEntity.ok(dto);
    }
    ...
    public ResponseEntity<ClientRecord> delete(@PathVariable Long id) {
        service.delete(id);
